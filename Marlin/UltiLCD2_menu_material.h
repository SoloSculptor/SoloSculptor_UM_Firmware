...
//linanw changed
//original code #define FILAMENT_REVERSAL_LENGTH      (FILAMANT_BOWDEN_LENGTH + 50)
#define FILAMENT_REVERSAL_LENGTH      (FILAMANT_BOWDEN_LENGTH + 120)
//end linanw
...
//linanw changed
//original code #define FILAMENT_FORWARD_LENGTH       (FILAMANT_BOWDEN_LENGTH - 50)
#define FILAMENT_FORWARD_LENGTH       (FILAMANT_BOWDEN_LENGTH - 0) 
//end linanw
