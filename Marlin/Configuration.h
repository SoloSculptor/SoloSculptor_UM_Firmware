...
//linanw changed
//original code #define STRING_CONFIG_H_AUTHOR "Version DEV" // Who made the changes.
...
#ifndef EXTRUDERS
  //linanw added extruder amount decided by Macro DUAL
  //original code #define EXTRUDERS 1
  #ifdef DUAL_EXTRUSION
    #define EXTRUDERS 2
  #else
    #define EXTRUDERS 1
...
//linanw changed for DW 1st Gen Extruder  
/* original code
...
// Travel limits after homing
#ifdef MINI
  #define X_MAX_POS 122   //linanw to-do: need to check if toolhead will hit printer case on right side.
  #define X_MIN_POS -14
  ...
  #define X_MAX_POS 222   //linanw to-do: need to check if toolhead will hit printer case on right side.
  #define X_MIN_POS 0
  #define Y_MAX_POS 224.5
  #define Y_MIN_POS 0
  //linanw added Macro PLUS decided Z_MAX_POS amount
  //original code #define Z_MAX_POS 325
  #ifdef PLUS
...
// default settings
//linanw changed
//original code #define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0,80.0,200,369}   // default steps per unit for ultimaker2.1 JarJar
#ifdef DW_EXTRUDER_GEN1
  #define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0,80.0,400,340}   //400 is for 16 micro-steps, 340 is for DW 1st gen extruder
#else
  #define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0,80.0,400,369}   //400 is for 16 micro-steps, 369 is default for UM2+
#endif
//end linanw
...
#define EXTRUDER_OFFSET_X {0.0, 18.00} //linanw uncomment and set to 18 was 20// (in mm) for each extruder, offset of the hotend on the X axis
...
//linanw changed to support MINI
#ifdef MINI
...
//linanw changed
#define LEVELING_OFFSET 0.26				// Assumed thickness of feeler gauge/paper used in leveling (mm)
//end linanw
