...
//linanw added enable auto fan by Macro NO_AUTO_FAN
//original code #define EXTRUDER_AUTO_FAN_TEMPERATURE 40
#ifdef NO_AUTO_FAN
  #define EXTRUDER_AUTO_FAN_TEMPERATURE 940 //define a very high number to keep the fan stop. 
#else
